package com.example.ranjithscalculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b0 = findViewById(R.id.bz);
        bpi = findViewById(R.id.bpi);
        bdot = findViewById(R.id.bdd);
        bequal = findViewById(R.id.be);
        bfact = findViewById(R.id.bxx);
        ...
        bmin = findViewById(R.id.bs);
        bmul = findViewById(R.id.bm);
        bdiv = findViewById(R.id.bd);
        bsqrt = findViewById(R.id.bsq);
        bsquare = findViewById(R.id.bxxx);
